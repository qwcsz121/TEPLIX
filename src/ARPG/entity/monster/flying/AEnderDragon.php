...
use ARPG\entity\projectile\ADragonFireBall;
...
/*  
  $entry[] = new Attribute($this->getId(), "minecraft:on_death", 0, $this->getHealth(), 40);
...
*/  
 ...
 public function getDrops(){
  if($this->lastDamageCause instanceof EntityDamageByEntityEvent and mt_rand(0, 12) == 2){
   return [Item::get(444, 0, mt_rand(0, 2))];
  }
  return [];
 }
