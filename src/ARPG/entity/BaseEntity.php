...
abstract class BaseEntity extends Creature{
 ...
 public function attack($damage, EntityDamageEvent $source){
  ...
  $this->setNameTag($this->arpg["名字"]." §b§l【§e{$this->getHealth()}§f/§4{$this->getMaxHealth()}§b§l】§f  "  );
 ...
 public function close(){  
  ...
  if(isset($plugin->spawnTmp[$this->arpg["刷怪点"]]["数量"]) and $this->clear){
   
   $this->clear = false;
   $plugin->spawnTmp[$this->arpg["刷怪点"]]["数量"] --;
  }
